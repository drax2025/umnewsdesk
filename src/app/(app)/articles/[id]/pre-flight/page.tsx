 ...
 *   Pack panel  · assembly + [PUB] Editor verdict
 *
      ...
      <div className="flex-1 overflow-y-auto bg-background px-6 py-5">
        <div className="mx-auto flex max-w-[960px] flex-col gap-3">
          ...
          <div id="pub-approval" className="flex scroll-mt-4 flex-col gap-3">
            <SectionHeader
              label="Pre-Flight Pack — Editor [PUB] APPROVE"
              hint="Hard cap of 3 articles per pack. Stamped to [PUB] for Editor APPROVE / MODIFY / REJECT — APPROVE moves the article to scheduled and unlocks F8 Publish."
            />
            <F7PackPanel
              articleId={article.id}
              row={row ?? null}
