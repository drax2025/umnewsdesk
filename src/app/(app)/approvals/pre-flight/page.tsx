...
/**
 * /approvals/pre-flight — Editor [PUB] queue.
 *
 * Lists every Pre-Flight Pack that F7 has handed to the Editor. Each
 ...
 *
 * Editor / Admin gate the verdict form. Reviewers + viewers see read-only roll-ups +
        ...
        <span className="ml-auto text-[11px] text-um-muted">
          ...
          {canStamp ? null : (
            <span className="ml-2 rounded-md border border-warn/35 bg-warn/10 px-2 py-0.5 font-mono text-[10.5px] uppercase tracking-[0.05em] text-warn">
              Read-only — Editor stamps verdicts
            </span>
          )}
        </span>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-border bg-card/40 px-6 py-16 text-center">
      ...
      <h2 className="text-[13px] font-semibold text-foreground">
        {tab === "pending"
          ? "No packs awaiting approval"
          : "No recent decisions"}
      </h2>
      <p className="mt-1 max-w-md text-[12px] leading-[1.5] text-um-muted">
        {tab === "pending"
          ? "Packs land here when F7 stamps HAND TO EDITOR. Hard cap of three articles per pack."
